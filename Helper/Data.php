 ...
 */
namespace Apexx\Applepay\Helper;
...
class Data extends AbstractHelper
{
     ...
     * Config paths
     */
    const XML_CONFIG_PATH_APPLEPAYPAYMENT  = 'payment/applepay_gateway';
    const XML_PATH_PAYMENT_APPLEPAY        = 'payment/apexx_section/apexxpayment/applepay_gateway';
    ...
    public function getConfigPathValue($key)
    {
        return $this->scopeConfig->getValue(
            self::XML_CONFIG_PATH_APPLEPAYPAYMENT . $key,
    ...
    {
        return $this->scopeConfig->getValue(
            self::XML_PATH_PAYMENT_APPLEPAY . $key,
            ScopeInterface::SCOPE_STORE
        );
    }
